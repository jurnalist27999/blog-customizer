...
}; /* фрагмент кода создает компонент Option, который содержит определенный элемент li,
 а также обрабатывает нажатия клавиш и кликов для выполнения некоторых действий,
